...
set_target_properties(Halide::Halide PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libHalide.12.0.1.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libHalide.12.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS Halide::Halide )
list(APPEND _IMPORT_CHECK_FILES_FOR_Halide::Halide "${_IMPORT_PREFIX}/lib/libHalide.12.0.1.dylib" )
